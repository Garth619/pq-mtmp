<section id='section_five'>
  ...
  <div id='sec_five_inner'>
      ...
      <div class='sec_five_post'>
        ...
        <a href="<?php the_permalink();?>">
          ...
          <div class='sec_five_post_image_wrapper'>
            ...
            <img class="lazyload sec_five_image" data-src="<?php echo $post_image['url']; ?>"
              alt="<?php echo $post_image['alt']; ?>" />

            <img class='sec_five_placeholder' src='<?php bloginfo('template_directory');?>/images/placeholder2.jpg'
              alt='' />
    ...
    if (get_sub_field('sec_five_post_title')) {

        $text = get_sub_field('sec_five_post_title');
        $text = ucwords(strtolower($text));

        ?>

            <span class='sec_five_post_title'><?php echo $text; ?></span>
            <!-- class -->
        ...
        ?>
            ...
            <span class='sec_five_post_title'><?php echo $text; ?></span><!-- class -->

            <?php }?>

            <span class='sec_five_post_descrip'><?php the_sub_field('description');?></span>
            <!-- sec_five_post_descrip -->
    ...
    <a id='sec_five_button' class="button"
      href='<?php the_field('section_five_view_all_page_link');?>'><span><?php the_field('section_five_button_verbiage');?></span></a>
    <!-- class -->
