<div class='sec_six_post'>
  ...
  <div class='sec_six_meta'>
    ...
    <span class='sec_six_date'><?php $pfx_date = get_the_date();
echo $pfx_date?></span><!-- sec_six_date -->
  ...
  <div class='sec_six_page_title_wrapper'>
    ...
    ?>
      ...
      <span
        class='sec_six_page_title <?php if (has_post_thumbnail()) {echo "has_image";} else {echo "no_image";}?>'><?php the_title();?></span>
      <!-- sec_six_page_title -->
